...
//        imagefilter($img, IMG_FILTER_CONTRAST, -80);
        ...
        $opcoes_http = array(
            'arquivo' => 'captcha.'.$_SERVER['REQUEST_TIME'].'.jpg',
            'compactacao' => true
        );

        // Exibir a imagem
        http::cabecalho('image/jpeg', $opcoes_http);
        imagejpeg($img, null, 70); // Qualidade ruim para estragar a imagem
        imagedestroy($img);
    }
