...
/// @ METODOS QUE PODEM SER SOBRECARREGADOS
    ...
    //
        ...
        case '3086':
            return array('Letter', 'P', 'mm', 1, 2, 212.700, 138.100, 212.730, 138.110, 1.300, 1.600);
        case '3087':
            return array('Letter', 'P', 'mm', 4, 20, 47.000, 12.500, 44.450, 12.700, 13.700, 14.000);
        case '3088':
            return array('Letter', 'L', 'mm', 2, 2, 138.100, 106.400, 138.110, 106.360, 1.300, 1.600);
        case '3089':
            return array('Letter', 'P', 'mm', 4, 15, 48.000, 17.000, 44.450, 16.930, 13.700, 12.000);
        case '3095':
            return array('Letter', 'P', 'mm', 2, 4, 96.300, 59.300, 85.730, 59.270, 16.700, 21.200);
        case 'A4047':
            return array('A4', 'P', 'mm', 1, 5, 150.000, 50.000, 150.000, 49.000, 29.700, 24.000);
        case 'A4048':
            return array('A4', 'P', 'mm', 6, 16, 33.000, 17.000, 31.000, 17.000, 5.700, 12.500);

// Especificas de fabricantes

        case 'Avery 8923-2':
            return array(array(200, 305), 'P', 'mm', 2, 12, 92.000, 25.500, 89.000, 23.400, 10.000, 1.500);
        case 'Pimaco 7023':
            return array(array(167.5, 304.5), 'P', 'mm', 2, 12, 73.600, 25.400, 70.000, 23.800, 11.000, 00.000);
        case 'Pimaco 6181':
            return self::get_medidas_tipo('3081');
        case 'Polifix 5x5':
            return array('Letter', 'P', 'mm', 2, 5, 106.800, 50.800, 101.600, 50.800, 3.500, 15.000);
