...
final class html2xml {
    ...
    public static $requer_filho = array(
        'applet', 'button', 'fieldset', 'frameset', 'map', 'noframes',
        'object', 'optgroup', 'select', 'table', 'tbody', 'thead',
        'tfoot', 'tr', 'menu', 'ol', 'ul', 'form'
    );

    // Vetor de elementos que nao podem ser fechados
    public static $nao_fechar = array(
        'area', 'base', 'basefont', 'br', 'col', 'frame', 'hr', 'img',
        'input', 'isindex', 'link', 'meta', 'param'
    );

    // Vetor de elementos com fechamento opcional
    public static $opcionais = array(
        'body', 'colgroup', 'dd', 'dt', 'head', 'html', 'li', 'option',
        'p', 'tbody', 'td', 'tfoot', 'th', 'thead', 'tr'
    );

    // Vetor de elementos depreciados
    public static $depreciados = array(
        'applet', 'basefont', 'center', 'dir', 'font', 'isindex', 'menu',
        'strike', 's', 'u', 'i', 'b', 'layer', 'marquee', 'embed',
        'noembed', 'shadow'
    );

    // Vetor de atributos depreciados
    public static $atributos_depreciados = array(
        'width', 'height', 'leftmargin', 'topmargin', 'rightmargin',
        'bottommargin', 'marginwidth', 'marginheight', 'margin', 'padding',
        'cellpadding', 'cellspacing', 'target', 'background', 'border',
        'bordercolor', 'bgcolor', 'color', 'alink', 'vlink', 'align',
        'valign', 'language', 'link', 'noshade', 'nowrap', 'size',
        'start', 'text', 'compact', 'scrolling'
    );

    // Vetor de atributos booleanos
    public static $atributos_booleanos = array(
    ...
    //
        ...
        // Elementos INLINE
        $inline = array(
            'a', 'abbr', 'acronym', 'area', 'b', 'basefont', 'bdo',
            'big', 'br', 'cite', 'code', 'dfn', 'em', 'font', 'i', 'img',
            'ins', 'kdb', 'param', 'q', 's', 'samp', 'small', 'span',
