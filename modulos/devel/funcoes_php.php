...
//
    ...
    if ($dados->num_resultados > 1) {
        echo "<h2>".texto::numero($dados->num_resultados)." Resultados mais Relevantes</h2>\n";
        echo "<ul>\n";
...
//
    ...
    $dados->funcao = formulario::filtrar('string', $dados->funcao);
    $dados->num_resultados = formulario::filtrar('int', $dados->num_resultados);
}
