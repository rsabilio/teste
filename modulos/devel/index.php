...
function listar_opcoes_devel() {
    ...
    // Informacoes
    $info = array(
        'info.php'        => 'Informa&ccedil;&otilde;es do Servidor',
    ...
    // Informacoes do BD
    $info_bd = array(
        'tabelas_bd.php' => 'Tabelas do BD',
        'tamanho_bd.php' => 'Tamanho do BD',
