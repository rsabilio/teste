...
$memoria = number_format(16 + intval(0.6 * $total_entidades), 0, '.', '');
...
//
    ...
    if ($operacoes) {
        ...
        if (!empty($vt_criar_entidades_cod)) {
        ...
        if (!empty($vt_criar_atributos_cod)) {
        ...
        if (!empty($vt_remover_atributos_cod)) {
