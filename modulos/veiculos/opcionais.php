...
/// Dados do Formulario
$entidade = util::get_entidade('veiculo');
$dados_form = new stdClass();
$dados_form->prefixo = 'opcionais';
$dados_form->nome_vetor = 'opcionais';        // Vetor da classe usuario (tipo usuarios_grupos)
$dados_form->classe_relacionada = 'opcional'; // Objeto da classe usuarios_grupos
...
modulo::relacionamento('veiculo', $dados_form);
