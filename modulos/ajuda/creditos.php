...
function imprimir_creditos() {
    ...
    $nome_sistema = texto::codificar($CFG->titulo);
    $descricao_sistema = texto::codificar($CFG->descricao);
    $versao_sistema = texto::codificar($CFG->versao);
    ...
    $descricao_simp = texto::codificar(DESCRICAO_SIMP);
    $versao_simp = texto::codificar(VERSAO_SIMP);
